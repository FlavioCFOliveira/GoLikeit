...
// newTestSQLiteStorage creates a test SQLite storage.
...
func TestSQLiteStorage_AddReaction(t *testing.T) {
...
func TestSQLiteStorage_RemoveReaction(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetUserReaction(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_HasUserReaction(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetEntityCounts(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetUserReactions(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetUserReactionCounts(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetUserReactionsByType(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetEntityReactions(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetRecentReactions(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetLastReactionTime(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteStorage_GetEntityReactionDetail(t *testing.T) {
	storage := newTestSQLiteStorage(t)
	defer storage.Close()
...
func TestSQLiteConfig_Default(t *testing.T) {
	config := DefaultSQLiteConfig()
	if config.DataSourceName != "golikeit.db" {
		t.Errorf("Expected DSN golikeit.db, got %s", config.DataSourceName)
	}
...
func TestSQLiteConfig_Memory(t *testing.T) {
	config := DefaultSQLiteMemoryConfig()
	if config.DataSourceName != ":memory:" {
		t.Errorf("Expected DSN :memory:, got %s", config.DataSourceName)
	}
